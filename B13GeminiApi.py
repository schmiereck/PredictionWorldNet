...
class GeminiInterface:
    ...
    def _mock_translate(self, command: str) -> dict:
        ...
        mappings = [
            ...
            (["gelbe box", "gelben box", "gelber box", "gelbe kiste", "yellow box"],
             "find the yellow box", 0.95),
            (["orange box", "orangen box", "orangene box", "orange kiste"],
             "find the orange box", 0.95),
            (["weiße box", "weißen box", "weißer box", "weiße kiste", "white box"],
             "find the white box", 0.95),
            (["grünen ball", "grüner ball", "grüne ball", "green ball"],
             "find the green ball", 0.95),
...
def run_demo():
    ...
    action_hints = {
        ...
        "find the green ball":        "linear_x=+0.3, angular_z=+0.4",
        "find the orange box":        "linear_x=+0.3, duration=1.0s",
        "find the yellow box":        "linear_x=+0.3, duration=1.0s",
        "find the white box":         "linear_x=+0.3, duration=1.0s",
